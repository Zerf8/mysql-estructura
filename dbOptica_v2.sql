...
CREATE TABLE IF NOT EXISTS `dboptica`.`dtclients` (
  ...
  `carrer` VARCHAR(70) NULL DEFAULT NULL,
  `numero` VARCHAR(15) NULL DEFAULT NULL,
  `telf` INT(12) NULL DEFAULT NULL,
  `dataRegistre` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP(),
  `idRecomendadoCliente` INT(7) NULL DEFAULT NULL,
  PRIMARY KEY (`idClient`),
  INDEX `fk_client_recomenat_idx` (`idRecomendadoCliente` ASC) ,
  CONSTRAINT `fk_client_recomenat`
    FOREIGN KEY (`idRecomendadoCliente`)
...
-- -----------------------------------------------------
-- Table `dboptica`.`dtmarcas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dboptica`.`dtmarcas` (
  `idMarca` INT(4) NOT NULL,
  `marca` VARCHAR(35) NULL DEFAULT NULL,
  `idProveidor` INT(4) NULL DEFAULT NULL,
  PRIMARY KEY (`idMarca`),
  INDEX `fk_marca_proveidor_idx` (`idProveidor` ASC) ,
